...
" Do You have a problem you can find your solution here."<b></i></pre></div>
    ...
    <div class="bottomdiv">
        <p> Copyrights @2024 and Developed by V.Yogesh(212223230250)
</body>
<html>
...
<body background="backk.jpeg">
    ...
    <div class="bottomdiv">
        <b>Copyrights @2024 and Developed by V.Yoges(212223230250)</b>
    </div>
</body>
</html>
...
<body>
    <div class="header">
        ...
        <table class="person">
            <tr>
                <td>
                    <img src="ajith.jpeg" width="100" height="160">
                </td>
		

                <td>
                    <img src="sam.jpeg" width="100" height="160">
                </td>
    ...
    <div class="bottomdiv">
<p>Copyrights @2024 and Developed BY V.Yogesh(212223230250)</p>
    </div>
</body>
</html>
        ...
        <div class="contact">
            <table cellpadding="15px" cellspacing="15px" class="table1">
                <tr>
                    ...
                    <td>
                        No:120,Gandhi st,Redhills,Chennai.
</td>
                </tr>
                <tr>
                    <td>
